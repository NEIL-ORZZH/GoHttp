...
public class HintView extends LinearLayout {
	...
	public void hint(int iconId, String hintText, String buttonName, View.OnClickListener buttonClickListener, boolean transparent){
		if(iconId > 0){
	 ...
	 * @param buttonClickListener 按钮的按下事件
	 */
	public void hint(int iconId, String hintText, String buttonName, View.OnClickListener buttonClickListener){
	 ...
	 * @param transparent 是否需要让提示视图变成透明的，透明的提示视图将不再拦截事件
	 */
	public void hint(String hintText, String buttonName, View.OnClickListener buttonClickListener, boolean transparent){
	 ...
	 * @param buttonClickListener 按钮的按下事件
	 */
	public void hint(String hintText, String buttonName, View.OnClickListener buttonClickListener){
	...
	public void failure(Failure failure, View.OnClickListener reloadButtonClickListener){
		if(failure.isException()){
			hint(R.drawable.ic_failure, failure.getMessage(), "刷新", reloadButtonClickListener, false);
		}else{
